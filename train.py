...
CONFIG = {
    ...
    "training": {
        ...
        "min_f1_delta": 0.001,
        "progressive_loading": True,       # Aktifkan/non-aktifkan fitur ini
        "initial_samples": 2000,           # Jumlah sampel di epoch pertama
...
def main(args):
    ...
    CONFIG['training']['progress_save_path'] = os.path.join(args.model_dir, 'training_progress.json')
