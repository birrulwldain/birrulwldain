...
class MixedSpectrumSimulator:
    ...
    def generate_sample(self, ionization_energies: Dict[str, float]) -> Tuple[Optional[np.ndarray], Optional[np.ndarray], Optional[np.ndarray], Optional[Dict]]:
        ...
        num_target_elements = np.random.randint(5, 10)
...
class DatasetGenerator:
    ...
    def generate_dataset(
        ...
        np.random.seed(42)
        self.combinations_json_path = os.path.join(processed_dir, "combinations-35.json")
        ...
        output_filename = "spectral_dataset-35.h5"
